...
const struct wl_data_device_manager_interface DataControlDeviceManagerInterface::Private::s_interface = {
...
{
    DataControlSourceInterface *dataSource = new DataControlSourceInterface(q, resource);
...
void DataControlDeviceManagerInterface::Private::getDataDevice(wl_client *client, wl_resource *resource, uint32_t id, wl_resource *seat)
{
    ...
    Q_ASSERT(s);
    DataControlDeviceInterface *dataDevice = new DataControlDeviceInterface(s, q, resource);
