...
void TextInputInterface::deleteSurroundingText(qint32 index, quint32 length)
{
    Q_D();
    d->deleteSurroundingText(index, length);
}

void TextInputInterface::cursorPosition(qint32 index, qint32 anchor)
{
    Q_D();
    d->cursorPosition(index, anchor);
}

void TextInputInterface::textDirection(Qt::LayoutDirection direction)
{
    Q_D();
    d->textDirection(direction);
}

void TextInputInterface::preEditCursor(qint32 index)
{
    Q_D();
    d->preEditCursor(index);
}

void TextInputInterface::inputPanelState(bool visible, const QRect &overlappedSurfaceArea)
{
    Q_D();
