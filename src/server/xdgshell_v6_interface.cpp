...
#ifndef K_DOXYGEN
const struct zxdg_shell_v6_interface XdgShellV6Interface::Private::s_interface = {destroyCallback,
...
{
    auto it = std::find_if(surfaces.constBegin(), surfaces.constEnd(), [surface](XdgSurfaceV6Interface *s) {
        return false;
    ...
    QObject::connect(shellSurface, &XdgSurfaceV6Interface::destroyed, q, [this, shellSurface] {
...
void XdgShellV6Interface::Private::createPositioner(wl_client *client, uint32_t version, uint32_t id, wl_resource *parentResource)
{
    ...
    QObject::connect(positioner, &Resource::destroyed, q, [this, positioner] {
...
#ifndef K_DOXYGEN
const struct zxdg_surface_v6_interface XdgSurfaceV6Interface::Private::s_interface = {destroyCallback,
                                                                                      getTopLevelCallback,
                                                                                      getPopupCallback,
...
void XdgSurfaceV6Interface::Private::createPopup(wl_client *client,
                                                 uint32_t version,
                                                 uint32_t id,
                                                 wl_resource *parentResource,
                                                 wl_resource *parentSurface,
...
void XdgSurfaceV6Interface::Private::setWindowGeometryCallback(wl_client *client, wl_resource *resource, int32_t x, int32_t y, int32_t width, int32_t height)
{
    ...
    if (width < 0 || height < 0) {
        wl_resource_post_error(resource, ZXDG_SHELL_V6_ERROR_INVALID_SURFACE_STATE, "Tried to set invalid xdg-surface geometry");
        return;
    }
...
#ifndef K_DOXYGEN
const struct zxdg_positioner_v6_interface XdgPositionerV6Interface::Private::s_interface = {resourceDestroyedCallback,
                                                                                            setSizeCallback,
...
QRect XdgTopLevelV6Interface::Private::windowGeometry() const
{
    return m_currentState.windowGeometry;
}

QSize XdgTopLevelV6Interface::Private::minimumSize() const
{
    return m_currentState.minimumSize;
}

QSize XdgTopLevelV6Interface::Private::maximumSize() const
{
...
{
    if (width < 0 || height < 0) {
        wl_resource_post_error(resource, ZXDG_SHELL_V6_ERROR_INVALID_SURFACE_STATE, "Tried to set invalid xdg-toplevel maximum size");
        return;
    }
    if (width == 0) {
        width = INT32_MAX;
...
{
    if (width < 0 || height < 0) {
        wl_resource_post_error(resource, ZXDG_SHELL_V6_ERROR_INVALID_SURFACE_STATE, "Tried to set invalid xdg-toplevel minimum size");
        return;
    }
    auto s = cast<Private>(resource);
    Q_ASSERT(client == *s->client);
...
void XdgTopLevelV6Interface::Private::setWindowGeometryCallback(const QRect &rect)
{
    m_pendingState.windowGeometry = rect;
    m_pendingState.windowGeometryIsSet = true;
}

const struct zxdg_toplevel_v6_interface XdgTopLevelV6Interface::Private::s_interface = {destroyCallback,
                                                                                        setParentCallback,
                                                                                        setTitleCallback,
                                                                                        setAppIdCallback,
...
void XdgTopLevelV6Interface::Private::commit()
{
...
#ifndef K_DOXYGEN
const struct zxdg_popup_v6_interface XdgPopupV6Interface::Private::s_interface = {resourceDestroyedCallback, grabCallback};
#endif
...
QRect XdgPopupV6Interface::Private::windowGeometry() const
{
    return m_currentState.windowGeometry;
}

void XdgPopupV6Interface::Private::commit()
{
    const bool windowGeometryChanged = m_pendingState.windowGeometryIsSet;
...
void XdgPopupV6Interface::Private::setWindowGeometryCallback(const QRect &rect)
{
    m_pendingState.windowGeometry = rect;
    m_pendingState.windowGeometryIsSet = true;
}
