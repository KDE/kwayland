...
****************************************************************************/
#ifndef KWAYLAND_SERVER_TEXT_H
#define KWAYLAND_SERVER_TEXT_H
 ...
 * and might change. If one needs to know the actual used protocol, use the method version.
 *
 * @since 5.23
 **/
...
public:
    ...
    /**
     * @return The surface the TextInputInterface is active on
     **/
     ...
     *
     * @param index is relative to the current cursor (in bytes).
     * @param length is the length of deleted text (in bytes).
     * @see commit
     **/
     ...
     **/
    void textDirection(Qt::LayoutDirection direction);
     ...
     **/
    void inputPanelState(bool visible, const QRect &overlappedSurfaceArea);
