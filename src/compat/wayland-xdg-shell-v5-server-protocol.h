...
struct zxdg_shell_v5_interface {
	 ...
	 */
	void (*get_zxdg_surface)(struct wl_client *client,
				struct wl_resource *resource,
				uint32_t id,
 ...
 */
static inline void
zxdg_shell_v5_send_ping(struct wl_resource *resource_, uint32_t serial)
{
 ...
 */
static inline void
zxdg_surface_v5_send_configure(struct wl_resource *resource_, int32_t width, int32_t height, struct wl_array *states, uint32_t serial)
{
 ...
 */
static inline void
zxdg_surface_v5_send_close(struct wl_resource *resource_)
{
 ...
 */
static inline void
zxdg_popup_v5_send_popup_done(struct wl_resource *resource_)
{
