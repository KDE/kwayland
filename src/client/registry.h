...
struct org_kde_plasma_virtual_desktop_management_v1;
...
class Output;
class PlasmaShell;
class PlasmaVirtualDesktopManagementUnstableV1;
...
public:
    ...
    enum class Interface {
        ...
        PlasmaVirtualDesktopManagementUnstableV1, ///< Refers to org_kde_plasma_virtual_desktop_management_v1 interface @since 5.47
    ...
    /**
     * Binds the org_kde_plasma_virtual_desktop_management_v1 with @p name and @p version.
     ...
     * @since 5.46
     **/
    org_kde_plasma_virtual_desktop_management_v1 *bindPlasmaVirtualDesktopManagementUnstableV1(uint32_t name, uint32_t version) const;
    /**
    ...
    /**
     * Creates a PlasmaVirtualDesktopManagementUnstableV1 and sets it up to manage the interface identified by
     * @p name and @p version.
     *
     * Note: in case @p name is invalid or isn't for the org_kde_plasma_virtual_desktop_management_v1 interface,
     * the returned VirtualDesktop will not be valid. Therefore it's recommended to call
     * isValid on the created instance.
     *
     * @param name The name of the org_kde_plasma_virtual_desktop_management_v1 interface to bind
     * @param version The version or the org_kde_plasma_virtual_desktop_management_v1 interface to use
     * @param parent The parent for PlasmaShell
     *
     * @returns The created PlasmaShell.
     * @since 5.46
     **/
    PlasmaVirtualDesktopManagementUnstableV1 *createPlasmaVirtualDesktopManagementUnstableV1(quint32 name, quint32 version, QObject *parent = nullptr);
    /**
...
Q_SIGNALS:
    ...
    /**
     * Emitted whenever a org_kde_plasma_virtual_desktop_management_v1 interface gets announced.
     * @param name The name for the announced interface
     * @param version The maximum supported version of the announced interface
     * @since 5.46
     **/
    void plasmaVirtualDesktopManagementUnstableV1Announced(quint32 name, quint32 version);
    /**
    ...
    /**
     * Emitted whenever a org_kde_plasma_virtual_desktop_management_v1 interface gets removed.
     * @param name The name for the removed interface
     * @since 5.46
     **/
    void plasmaVirtualDesktopManagementUnstableV1Removed(quint32 name);
    /**
