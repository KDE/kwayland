 ...
 *
 **/
class KWAYLANDSERVER_EXPORT DataControlOfferInterface : public Resource
{
    Q_OBJECT
public:
    virtual ~DataControlOfferInterface();

    void sendAllOffers();

private:
    friend class DataControlDeviceInterface;
    explicit DataControlOfferInterface(DataControlSourceInterface *source, DataControlDeviceInterface *parentInterface, wl_resource *parentResource);
...
Q_DECLARE_METATYPE(KWayland::Server::DataControlOfferInterface*)
