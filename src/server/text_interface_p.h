...
****************************************************************************/
#ifndef KWAYLAND_SERVER_TEXT_P_H
#define KWAYLAND_SERVER_TEXT_P_H
...
public:
    ...
    virtual void sendLeave(quint32 serial) = 0;
    ...
    virtual void textDirection(Qt::LayoutDirection direction) = 0;
    virtual void preEditCursor(qint32 index) = 0;
    virtual void cursorPosition(qint32 index, qint32 anchor) = 0;
...
Q_SIGNALS:
     ...
     * @internal
     **/
    void requestDeactivate(KWayland::Server::SeatInterface *);
